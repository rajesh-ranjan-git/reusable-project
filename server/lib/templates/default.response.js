    ...
    <main>
      <div class="shell">
        <section class="hero" aria-labelledby="page-title">
          <div>
            <div class="brand"><span class="pulse"></span> App Server</div>
            <h1 id="page-title">Server is <span class="gradient">up and running</span></h1>
            <p class="lede">
              This is the App Server backend service. REST APIs, realtime socket events,
              authentication, notifications, and integrations are online.
            </p>
          </div>
        ...
        <footer>&copy; ${new Date().getFullYear()} App Inc. All rights reserved.</footer>
      </div>
    </main>
    <script>
      (() => {
