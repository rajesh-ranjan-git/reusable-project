    ...
    <section className="pt-30 text-center animate-fade-in container">
      <div className="flex justify-center mb-4">
        ...
        >
          ...
          App v1.0 is now live
          <LuChevronRight size={14} className="ml-1" />
        </Link>
      </div>
      <h1 className="mx-auto mb-5 max-w-195 font-arima font-bold">
        Your&nbsp;
        <span className="text-gradient">App</span>&nbsp;title head goes here.
      </h1>
      <p className="mx-auto mb-9 max-w-160 text-text-secondary text-lg">
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sequi dolore
        voluptate tenetur reprehenderit exercitationem aliquam in ipsa, mollitia
        amet minus velit, ipsam numquam. Veniam voluptas atque debitis ipsam
        facilis? Possimus.
      </p>
