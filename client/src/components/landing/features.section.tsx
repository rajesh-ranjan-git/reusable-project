      ...
      <div className="mx-auto px-6 md:px-8 max-w-7xl">
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <p>
            ...
            itaque dolores, accusantium voluptates maiores necessitatibus
            quaerat beatae hic fuga sit voluptatibus laudantium expedita
            molestiae ipsam aperiam eveniet sunt est vitae?
          </p>
        </div>
